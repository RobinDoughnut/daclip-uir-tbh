...
# Add the universal-image-restoration directory to Python path
current_dir = os.path.dirname(os.path.abspath(__file__))
universal_restoration_dir = os.path.abspath(os.path.join(current_dir, "../.."))
sys.path.insert(0, universal_restoration_dir)
...
try:
    ...
    print(f"Looking for utils in: {universal_restoration_dir}")
    raise
...
def parse(opt_path, is_train=True):
    ...
    config_dir = path_parts[-2] if len(path_parts) > 1 else "daclip-sde"
    if is_train:
